...
this incorrectly (which is possible), your output file should have close to 1771 words in it (your
...
done this incorrectly (which is possible), your output file will have close to 25,142 words in it
